 ...
 */
public class reporteDocEntrada extends java.awt.Frame {

    /**
     * Creates new form reporteDocEntrada
     */
    String año,mes,dia;
    
    private iniciarReportesDocumentos jasper;
    String rep = "DocumentosDeEntrada.jasper";
    String titulo ="REPORTE DE DOCUMENTOS DE ENTRADA";
    String fecha;
    
    public reporteDocEntrada() {
        initComponents();
